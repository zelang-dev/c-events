...
#define HTTPIE_VERSION "0.8.0"
#define HTTPIE_VERSION_MAJOR (0)
#define HTTPIE_VERSION_MINOR (8)
#define HTTPIE_VERSION_PATCH (0)
...
#ifndef HTTPIE_THREAD
#	if defined(_WIN32)
#		define HTTPIE_THREAD			unsigned __stdcall
#		define HTTPIE_THREAD_TYPE		unsigned
#		define HTTPIE_THREAD_CALLING_CONV	__stdcall
#		define HTTPIE_THREAD_RETNULL		0
#	else  /* _WIN32 */
#		define HTTPIE_THREAD			void *
#		define HTTPIE_THREAD_TYPE		void *
#		define HTTPIE_THREAD_CALLING_CONV
#		define HTTPIE_THREAD_RETNULL		NULL
#	endif  /* _WIN32 */
#endif  /* HTTPIE_THREAD */
