...
C_API hash_pair_t *insert_func(hash_t *htable, const_t key, func_args_t value);
...
C_API hash_pair_t *insert_number(hash_t *htable, const_t key, long value);
...
C_API data_types hash_pair_type(hash_pair_t *);
...
C_API bool is_type(void_t, data_types);
C_API bool is_valid(void_t);
C_API bool is_union(void_t self);
