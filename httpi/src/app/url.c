...
/* Passed to http_start() by start_httpi() */
static struct tuser_data g_user_data;

#if !defined(CONFIG_FILE)
#define CONFIG_FILE "httpi.conf"
#endif /* !CONFIG_FILE */
...
#define CONFIG_FILE2 "/usr/local/etc/httpi.conf"
#endif
...
static void init_server_name(void) {
	DEBUG_ASSERT(sizeof(main_config_options) / sizeof(main_config_options[0])
		== NUM_MAIN_OPTIONS + 1);
	DEBUG_ASSERT((strlen(httpi_version()) + 12) < sizeof(g_server_base_name));
	...
	g_icon_name = NULL;
	g_website = "https://zelang-dev.github.io/httpi/";
	g_num_add_domains = 0;
	g_add_domain = NULL;
}
